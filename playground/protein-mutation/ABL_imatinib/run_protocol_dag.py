...
mutations_to_perform = (mutation_data["MUTATION"])
...
initial_aa, mut_id, final_aa = parse_mutation_spec(mutations_enum[protocol_dag_index])
...
protocol_dag_path = f"./{protocol_dags_dir}/NEqCycDAG_{initial_aa}-{mut_id}-{final_aa}.json"
...
protocol_result_dag.to_json(f"./{results_path}/NEqCycDAG_{initial_aa}-{mut_id}-{final_aa}.json")
