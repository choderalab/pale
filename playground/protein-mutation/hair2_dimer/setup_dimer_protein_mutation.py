...
# Protein components
structures_rootdir = "."
initial_structure = ProteinComponent.from_pdb_file(f"{structures_rootdir}/her2-for-mapping-p61r.pdb")
...
protocol_dag = protocol.create(stateA=initial_state, stateB=end_state, mapping=mapping, name=f"dimer_P61R")
